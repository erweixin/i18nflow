 ...
 * Key Prefix 示例子组件
 */
function KeyPrefixExample() {
  const { t } = useTranslation('api', { keyPrefix: 'keyPrefix' });
...
export default function ApiExample() {
  const { t, i18n, ready } = useTranslation('api');
          ...
          <p style={{ margin: '5px 0' }}>
            ...
            {t('interpolation.nested', {
              user: {
                name: '孙七',
                age: 25,
                city: i18n.language === 'zh-CN' ? '上海' : 'Shanghai',
              },
            })}
          </p>
        </div>
...
{
  "welcome": "欢迎",
  "fullWelcome": "$t(api:nesting.welcome)回来，{{name}}！"
}
